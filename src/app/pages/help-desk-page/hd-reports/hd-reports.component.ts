...
@Component({
    ...
    imports: [MatCardModule, MatMenuModule, MatButtonModule, RouterLink, MatTableModule, MatPaginatorModule, MatProgressBarModule, MatTooltipModule, ComplaintsComponent],
